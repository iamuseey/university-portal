  ...
  return (
    <div className="min-h-screen bg-gray-900 flex items-center justify-center">
      <div className="bg-gray-800 p-8 rounded-xl shadow-md w-full max-w-md">
        ...
        {/* Error Message */}
        {error && (
          <div className="bg-red-900 border-red-700 text-red-300 text-sm rounded-lg p-3 mb-4">
            {error}
          </div>
        )}
        ...
        <div className="mb-4">
          ...
          <input
            ...
            className="w-full border-gray-600 bg-gray-700 text-white rounded-lg p-3 text-sm focus:outline-none focus:ring-2 focus:ring-red-500"
          />
        </div>
